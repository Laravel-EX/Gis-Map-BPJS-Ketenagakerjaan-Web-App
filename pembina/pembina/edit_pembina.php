					...
					<div class="col-md-5">
						...
						<?php 
							...
							$sql = mysql_query("select * from pembina p, user u where p.id_user=u.id_user and p.id_pembina='$pembina'");
						...
						<form method="post" action="?page=pembina/pro_pem_edit.php">
							...
							<div class="form-group">
								...
								<select name="kantor" class="form-control">
									<?php 
										$dml = mysql_query("SELECT * FROM kantor k, pembina p where k.id_kantor=p.id_kantor and p.id_pembina='$pembina' ORDER BY p.id_kantor DESC");
