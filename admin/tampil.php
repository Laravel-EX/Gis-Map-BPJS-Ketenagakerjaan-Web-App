...
$s=mysql_query("select * from data_perusahaan where x<>''") or die (mysql_error());
...
?>

    {
        ...
        "lat": '<?php echo $r['x'] ?>',
        "lng": '<?php echo $r['y'] ?>',
        "description": '<b><?php echo $r['nama_perusahaan'] ?></b><br><?php echo $r['alamat'] ?><br> <img src=../bpjs/uploads/<?php echo $r['foto']; ?> width="50%"><br><b>Jumlah Aktif</b>= <?php echo $r['jlh_aktif'];?>',
