	...
	<body>
				            ...
				            <div id="header-container" class="navbar-default navbar-container">
				                ...
				                <div id="navbar" class="collapse navbar-collapse">
				                    <ul class="nav navbar-nav">
				                        ...
				                        <li><a style="font-weight: bold; color: black; font-size: 17px;" href="?page=pembina/pembina.php">Pembina</a></li>
				                        <li><a style="font-weight: bold; color: black; font-size: 17px;" href="?page=kantor/kantor.php">Kantor</a></li>
				                         <li><a style="font-weight: bold; color: black; font-size: 17px;" href="?page=laporan.php">Laporan</a></li>
	    ...
	    <script>
	    	$(document).ready(function(){
			    $("#getkantor").click(function(){
			        alert("The text has been changed.");
			    });

			    //get perintis
		        $("#cek1").change(function(event) {
		        	var cek1 = $("#cek1").val();
		        	$("#perintis").load('getperintis.php', {"cek1":cek1});
		        });
			});
	    </script>
	</body>
