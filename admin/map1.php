...
<head>
	<script type="text/javascript">
	  ...
	  function initAutocomplete() {
	    var map = new google.maps.Map(document.getElementById('map'), {
	      center: {lat: 3.5930901304831946, lng: 98.67180922999978},
	      zoom: 13,
	      mapTypeId: 'roadmap'
	    });
	...
	<div class="col-md-3">
		<div class="myform">
			<form method="post" action="simpan_lokasi_baru.php">
			<div class="form-group">
					<label>Kantor</label>
					<select class="form-control" name="kantor">
					<?php
					include "koneksi.php";
					$az=mysql_query("select * from kantor");
					while($aa=mysql_fetch_array($az))
					{ ?>
					<option value="<?php echo $aa['id_kantor']; ?>"><?php echo $aa['nama_kantor']; ?></option>
					<?php }
				...
				<div class="form-group">
					...
					<?php
					include "koneksi.php";
					$az=mysql_query("select * from pembina");
					while($aa=mysql_fetch_array($az))
					{ ?>
	...
	<?php } 
      ...
      google.maps.event.addDomListener(window, 'load', initialize);
		...
		<div class="col-md-3">
			<div class="myform">
				<form method="post" action="editsimpan_lokasi_baru.php">		
					<div class="form-group">
						<label>Koordinat X</label>
						<input type="text" name="koordinat_x" class="form-control" id="lat" placeholder="Koordinat X" 
						value="<?php echo $x; ?>">
